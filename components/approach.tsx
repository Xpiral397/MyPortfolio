...
const Card = ({
  ...
  return (
    ...
    >
      ...
      <Icon className="absolute w-10 h-10 text-black -top-3 -left-3 dark:text-white opacity-30" />
      <Icon className="absolute w-10 h-10 text-black -bottom-3 -left-3 dark:text-white opacity-30" />
      <Icon className="absolute w-10 h-10 text-black -top-3 -right-3 dark:text-white opacity-30" />
      <Icon className="absolute w-10 h-10 text-black -bottom-3 -right-3 dark:text-white opacity-30" />
      ...
      <div className="relative z-20 px-10">
        ...
        <h2
          ...
          className="relative z-10 mt-4 text-3xl font-bold text-center text-white transition duration-200 opacity-0 dark:text-black group-hover/canvas-card:opacity-100 group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2"
        >
          {title}
        </h2>
